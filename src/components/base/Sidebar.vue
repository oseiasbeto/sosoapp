<template>
    <ul
        class="flex items-center gap-2 w-full h-14 bg-light-bg dark:bg-dark-bg text-inherit fixed bottom-0 overflow-hidden">
        ...
        <li class="flex-1 h-full">
            <router-link class="flex items-center h-full" to="/search">
        ...
        <li class="flex-1 h-full">
            <router-link class="flex items-center h-full" to="/messages">
                <svg v-if="route.name === 'Messages'" xmlns="http://www.w3.org/2000/svg" class="mx-auto"
        ...
        <li class="flex-1 h-full">
            <router-link class="flex items-center h-full" to="/notifications">
