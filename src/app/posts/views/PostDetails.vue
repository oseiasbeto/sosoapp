        ...
        <div>
            <post-list :b-space="110" :posts="replies?.data || []" :is-replies="true" ref="postListComponent"
                ...
                <template #before-content>
                    ...
                    <!--start post details-->
                    <div v-if="!hasError">
                        <div class="mt-14" v-if="!loadingGetPostId">
                            <PostCard v-if="post.is_reply && post?.original_post?._id && !loadingGetOriginalPost"
                                :totalItems="0" :post-module="postModule" :index="0" :show-reactions="false"
                            ...
                            <div class="px-4 h-4 pb-1 w-full">
                                <div class="w-[44px] flex h-full" v-show="post.is_reply">
                                    <div
                                        class="w-0.5 h-full mx-auto bg-light-border dark:bg-dark-border">
                                    </div>
                                </div>
                            </div>
