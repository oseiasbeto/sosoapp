export default {
  ...
  setReplies(
    { commit },
    { replies, original_post, page, total, totalPages, hasMore }
  ) {
    commit("SET_REPLIES", {
      replies,
      page,
  ...
  setRepliesStore(
    { commit },
    { original_post, rafs, replies, page, total, totalPages, hasMore }
  ) {
    commit("SET_REPLIES_STORE", {
      original_post,
      rafs,
      replies,
      page,
  ...
  incRepliesCountFromPosts(
    { commit },
    { index, moduleIndex, isRepost, newReply }
  ) {
    commit("INC_REPLIES_COUNT_FROM_POSTS", {
      index,
      moduleIndex,
      isRepost,
      newReply,
  ...
  incRepliesCountFromRepliesStore(
    { commit },
    { index, postModule, newReplyId }
  ) {
    commit("INC_REPLIES_COUNT_FROM_REPLIES_STORE", {
      index,
      postModule,
      newReplyId,
    });
  ...
  toggleLikePost(
    { commit },
    { postId, postModule, userId, isRepost, originalRepostId }
  ) {
  ...
  toggleLikeReply(
    { commit },
    { replyId, userId, postModule, isOriginalPost, originalRepostId }
  ) {
    commit("TOGGLE_LIKE_REPLY", {
      replyId,
      userId,
      postModule,
      isOriginalPost,
  ...
  toggleRepostPost(
    { commit },
    { postId, isViewPage, originalPostId, isRepost, postModule, userId }
  ) {
    commit("TOGGLE_REPOST_POST", {
      originalPostId,
      postId,
      isViewPage,
      isRepost,
  ...
  toggleRepostReply(
    { commit },
    { replyId, userId, postModule, isPost, isViewPage }
  ) {
    commit("TOGGLE_REPOST_REPLY", {
      replyId,
      userId,
      postModule,
      isPost,
