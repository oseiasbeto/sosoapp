<template>
    <div class="fixed flex items-center w-full border-t border-b border-light-border dark:border-dark-border p-2 px-2 bg-light-bg dark:bg-dark-bg bottom-[56px] h-14"
